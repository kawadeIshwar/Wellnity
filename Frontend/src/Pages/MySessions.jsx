    ...
    <div className="min-h-screen  flex flex-col items-center justify-start py-10 px-4">
      <div className="w-full max-w-2xl">
        <div className="flex justify-center mb-2">
          <h1
            className="text-4xl font-bold mb-3 text-center text-purple-950 py-2 px-36"
            style={{
              textShadow: "2px 2px rgba(173, 216, 230, 1)",
            }}
          >
            My Sessions
          </h1>
        ...
        {sessions.length === 0 ? (
          ...
          <div className="flex flex-col  gap-3">
            {sessions.map((s) => (
              <div
                key={s._id}
                className="w-full p-4 rounded-xl shadow-xl transition-transform hover:-translate-y-1"
              >
